    ...
    return (
        <div style={{ textAlign: 'center' }}>
            ...
            {count.first > 0 &&
                <div>
                    <li>
                    Product A - Quantity: {count.first}<button onClick={() => dispatch("remA")} >Remove</button>
                    <button onClick={() => dispatch("decA")}>Decrease</button>
                    </li>
                </div>
            }
            {count.second > 0 &&
                <div>
                    <li>
                    Product B - Quantity: {count.second}<button onClick={() => dispatch("remB")}>Remove</button>
                    <button onClick={() => dispatch("decB")}>Decrease</button>
                    </li>
                </div>
            }
